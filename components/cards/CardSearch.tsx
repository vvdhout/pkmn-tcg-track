      ...
      <div className="px-3 py-3 border-b border-app-border">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-10 py-2.5 rounded-xl bg-app-elevated border border-app-border text-zinc-100 text-sm placeholder:text-zinc-600 outline-none focus:border-zinc-600"
          />
          {query && (
            <button
              onClick={clear}
